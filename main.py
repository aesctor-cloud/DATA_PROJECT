...
from EXTRACCION_VALORES.precio_alquiler import df_alquiler
from EXTRACCION_VALORES.precio_compra import df_compra
from EXTRACCION_VALORES.geo import df_geo
from EXTRACCION_VALORES.metro import df_metro
from EXTRACCION_VALORES.bus import df_bus
from EXTRACCION_VALORES.vulnerabilidad import df_vulne
from EXTRACCION_VALORES.hospitales import df_hospi
from EXTRACCION_VALORES.zonas_infantiles import df_zonas_infantiles
...
#puntuacion zonas_infantiles
min_zi = df_zonas_infantiles['cuenta'].min()
max_zi = df_zonas_infantiles['cuenta'].max()

df_zonas_infantiles['cuenta_normalizado'] = (df_zonas_infantiles['cuenta'] - min_zi) / (max_zi - min_zi)
...
df_zonas_infantiles['id'] = df_zonas_infantiles['id'].astype(str)
...
df_base = pd.merge(df_base, df_zonas_infantiles, on='id', how='left')
